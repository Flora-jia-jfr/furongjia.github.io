...
配色遵循 [Duke 官方品牌指南](https://brand.duke.edu/colors/)：Duke Navy `#012169`、Duke Royal `#00539B`，搭配官方中性色。浅色模式使用白底 Navy 文字，深色模式使用 Navy 背景和白色文字；色值标注在 `assets/site.css` 和 README 中。
